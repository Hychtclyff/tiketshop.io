export default function Event({ firstEvent, onEvent }) {
  const events = [
    { src: "../public/img/event1.jpg", alt: "event-1" },
    { src: "../public/img/event1.jpg", alt: "event-2" },
    { src: "../public/img/event1.jpg", alt: "event-3" },
    { src: "../public/img/event1.jpg", alt: "event-4" },
    { src: "../public/img/20240324100854_65ff99465d799.jpg", alt: "event-5" },
    { src: "../public/img/event1.jpg", alt: "event-1" },
    { src: "../public/img/event1.jpg", alt: "event-2" },
    { src: "../public/img/event1.jpg", alt: "event-3" },
    { src: "../public/img/event1.jpg", alt: "event-4" },
    { src: "../public/img/20240205125720.jpg", alt: "event-5" },
    { src: "../public/img/event1.jpg", alt: "event-1" },
    { src: "../public/img/event1.jpg", alt: "event-2" },
    { src: "../public/img/event1.jpg", alt: "event-3" },
    { src: "../public/img/event1.jpg", alt: "event-4" },
